...
|---|---|---|
| [**Draw-Together**](https://github.com/azeemabrarkhan/Draw-Together) | Collaborative vector drawing app - shape drawing, undo/redo, zoom/pan, export/import built from scratch on the Canvas API, with CI/CD deployment on every push | React, TypeScript, Canvas API |
| [**SAST-Tools-Analyzer**](https://github.com/azeemabrarkhan/SAST-Tools-Analyzer) | CLI tool automating analysis & comparison of Static Application Security Testing tool outputs with AND/OR logic | JavaScript |
| [**5G-Mobility-Simulation**](https://github.com/azeemabrarkhan/5G-Mobility-Simulation) | Simulates a 5G network for Urban Air Mobility (air taxis as UEs), evaluating latency & performance via OMNeT++/Simu5G | C++ |
| [**Flight-Globe**](https://github.com/azeemabrarkhan/Flight-Globe) | 3D globe visualization of user-defined flight routes with animated paths | Three.js, ThreeGlobe.js, JavaScript |
